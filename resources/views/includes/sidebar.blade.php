                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{route('leave.index')}}" class="nav-link ">
                                        <span class="title">Leave Dashboard</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                ...
                                <li class="nav-item  ">
                                    <a href="{{route('leave.approve')}}" class="nav-link ">
                                        <span class="title"> Approve / Decline Leave</span>
                                    </a>
                                </li>
                                @if(Auth::user()->department == "HR")
                                <li class="nav-item  ">
                                    <a href="{{route('leave.view')}}" class="nav-link ">
                                        <span class="title"> All Leave Applications</span>
                                    </a>
                                </li>

                                <li class="nav-item  ">
                                    <a href="{{route('leave.admin')}}" class="nav-link ">
                                        <span class="title"> Leave Audit Trail</span>
                                    </a>
                                </li>
                                @endif
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">Start Appraisal</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">View Appraisal History</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">Appraisal Status</span>
                                    </a>
                                </li>


                                <li class="nav-item  ">
                                    <a href="{{route('appraisal_year.index')}}" class="nav-link ">
                                        <span class="title">Appraisal Year</span>
                                    </a>
                                </li>

                                <li class="nav-item  ">
                                    <a href="{{route('appraisal.kpi')}}" class="nav-link ">
                                        <span class="title">Enter Appraisal KPI </span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">View Loan History</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">Expense Flow</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">View Expense History</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">Expense Status</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-user"></i>
                                <span class="title">Staff Records</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                ...
                                <li class="nav-item  ">
                                    <a href="{{route('staff.index')}}" class="nav-link ">
                                        <span class="title">View and Edit Staff</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="{{route('staff.index')}}" class="nav-link ">
                                        <span class="title">Delete Staff Record</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">Create Leave Type</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
