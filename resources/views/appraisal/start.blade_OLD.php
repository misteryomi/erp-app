                                                                                                    ...
                                                                                                    <div class="portlet-body">
                                                                                                      ...
                                                                                                      $appraisal_contents->manager_id) && ($appraisal_contents->manager_actioned == 1))
																												...
																												<tr class="odd gradeX">
																													...
																													<td colspan="6"><textarea disabled name = "competency_comment_manager" class="form-control" style="margin: 0px; width:100%; height: 170px;"
																																			  aria-invalid="false" required>{{$appraisal_contents->competency_comment_manager}}</textarea>
																													</td>
																											@else
																												<tr class="odd gradeX">
                                                                                                    ...
                                                                                                    <div class="portlet-body">
                                                                                                      ...
                                                                                                      $appraisal_contents->manager_id) && ($appraisal_contents->manager_actioned == 1))
																												...
																												<tr class="odd gradeX">
																													...
																													<td colspan="6"><textarea disabled name = "behavioural_comment_manager" class="form-control" style="margin: 0px; width:100%; height: 170px;"
																																			  aria-invalid="false" required>{{$appraisal_contents->behavioural_comment_manager}}</textarea>
																													</td>
																											@else
																												<tr class="odd gradeX">
                                                                                                    ...
                                                                                                    <div class="portlet-body">
                                                                                                      ...
                                                                                                      $appraisal_contents->manager_id) && ($appraisal_contents->manager_actioned == 1))
																												...
																												<tr class="odd gradeX">
																													...
																													<td colspan="6"><textarea disabled name = "development_comment_manager" class="form-control" style="margin: 0px; width:100%; height: 170px;"
																																			  aria-invalid="false" required>{{$appraisal_contents->development_comment_manager}}</textarea>
																													</td>
																											@else
																												<tr class="odd gradeX">
