@extends('layouts.app')
@section('page_title') SENT NOTIFICATIONS @endsection
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="#"> SENT NOTIFICATIONS </a> </li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="caption"> <i class="fa fa-globe"></i> SENT NOTIFICATIONS </div>
