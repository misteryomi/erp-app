                            ...
                            <div class="card-bodytyle="">
                                <form id="edit_kc_form" class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                       <input id="customer_name_edit" name = "customer_name"  type="text" required class="form-control">
...
-->                                                                                <td>{!!$flutterwafe->payment_type!!}</td>
        ...
        <td>@if(isset($flutterwafe->user_id) || ($flutterwafe->user_id != 0) ) {{ User::find($flutterwafe->user_id)->display_name   }}  @else  @endif</td>
