...
<section class="content">
    <h1>
        Create flutterwavetransaction
    </h1>
    <a href="{!!url('flutterwavetransaction')!!}" class = 'btn btn-danger'><i class="fa fa-home"></i> Flutterwavetransaction Index</a>
    <br>
    <form method = 'POST' action = '{!!url("flutterwavetransaction")!!}'>
        <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
        <div class="form-group">
            <label for="token_id">token_id</label>
            <input id="token_id" name = "token_id" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="transaction_reference" name = "transaction_reference" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="processor_reference">processor_reference</label>
            <input id="processor_reference" name = "processor_reference" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="amount_charged" name = "amount_charged" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="rave_fee">rave_fee</label>
            <input id="rave_fee" name = "rave_fee" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="merchant_fee">merchant_fee</label>
            <input id="merchant_fee" name = "merchant_fee" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="merchant_bore_fee">merchant_bore_fee</label>
            <input id="merchant_bore_fee" name = "merchant_bore_fee" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="processor_response_code">processor_response_code</label>
            <input id="processor_response_code" name = "processor_response_code" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="processor_response_message">processor_response_message</label>
            <input id="processor_response_message" name = "processor_response_message" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="auth_model">auth_model</label>
            <input id="auth_model" name = "auth_model" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="customer_ip">customer_ip</label>
            <input id="customer_ip" name = "customer_ip" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="payment_entity" name = "payment_entity" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="payment_entity_id">payment_entity_id</label>
            <input id="payment_entity_id" name = "payment_entity_id" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="date_created">date_created</label>
            <input id="date_created" name = "date_created" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="unique_reference">unique_reference</label>
            <input id="unique_reference" name = "unique_reference" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="amount_due_merchant">amount_due_merchant</label>
            <input id="amount_due_merchant" name = "amount_due_merchant" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="customer_phonenumber" name = "customer_phonenumber" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="customer_fullname">customer_fullname</label>
            <input id="customer_fullname" name = "customer_fullname" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="customer_date_created">customer_date_created</label>
            <input id="customer_date_created" name = "customer_date_created" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="masked_pan" name = "masked_pan" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="expiry_year">expiry_year</label>
            <input id="expiry_year" name = "expiry_year" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="expiry_month">expiry_month</label>
            <input id="expiry_month" name = "expiry_month" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="issuer_info" name = "issuer_info" type="text" class="form-control">
        </div>
        <div class="form-group">
            <label for="date_created">date_created</label>
            <input id="date_created" name = "date_created" type="text" class="form-control">
        ...
        <div class="form-group">
            ...
            <input id="payment_count" name = "payment_count" type="text" class="form-control">
        </div>
        <div class="form-group">
