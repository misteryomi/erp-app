      ...
      <table class="table table-hover table-sm">
            ...
            <tbody>
                ...
                @foreach($tickets as $ticket)
                    ...
                    <tr>
                        <td>{{ $count }}</td>
                        <td><a href="{{ route('tickets.admin.tickets.show', ['ticket' => $ticket->ticket_id]) }}">{{ $ticket->ticket_id }}</a></td>
                        <td><a href="{{ route('tickets.admin.tickets.show', ['ticket' => $ticket->ticket_id]) }}"><strong>{{ $ticket->title }}</strong></a></td>
                        <td>{{ $ticket->user->name }}</td>
                        <td>{!! $ticket->assignedTo ? "<a href='".route('tickets.admin.users.show', ['user' => $ticket->assignedTo->id])."'>".$ticket->assignedTo->name."</a>" : '-' !!}</td>
