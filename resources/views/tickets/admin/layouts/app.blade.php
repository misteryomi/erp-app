      ...
      <div class="t-header-content-wrapper">
        <div class="t-header-content">
          ...
          <ul class="nav ml-auto">
            <li class="nav-item">
             <a class="nav-link" href="{{ route('tickets.admin.logout') }}">
                Logout
              </a>
            </li>
          </ul>
        ...
        <ul class="navigation-menu">
          @php
            $routes = [
                ...
                [ "route" => route('tickets.admin.units.list'), "name" => "Manage Units", "icon" => 'mdi-arrange-bring-to-front'],
                [ "route" => route('tickets.admin.departments.list'), "name" => "Manage Departments", "icon" => 'mdi-altimeter'],
